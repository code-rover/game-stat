...
function charts() {
	...
	$("#consume-diamond").bind("plothover", function (event, pos, item) {
		...
		if($("#consume-diamond").length)
		{
			...
			$.ajax({
					url: dataurl + "?req=3&serverid="+chart4_serverid+"&snid="+chart4_snid,
					type: "GET",
					dataType: "json",
					success: onDataReceived
			});
	...
	$("#consume-gold").bind("plothover", function (event, pos, item) {
		...
		if($("#consume-gold").length)
		{
			...
			$.ajax({
					//url: dataurl + "?req=4",
					url: dataurl + "?req=4&serverid="+chart5_serverid+"&snid="+chart5_snid,
					type: "GET",
					dataType: "json",
					success: onDataReceived
			});
	...
	$("#chart-tutorial").bind("plothover", function (event, pos, item) {
		...
		if($("#chart-tutorial").length)
		{
			...
			$.ajax({
					url: dataurl + "?req=5&serverid="+chart6_serverid+"&snid="+chart6_snid,
					type: "GET",
					dataType: "json",
					success: onDataReceived
			});
	...
	$("#main-task").bind("plothover", function (event, pos, item) {
		...
		if($("#main-task").length)
		{
			...
			$.ajax({
					//url: dataurl + "?req=6",
					url: dataurl + "?req=6&serverid="+chart7_serverid+"&snid="+chart7_snid,
					type: "GET",
					dataType: "json",
					success: onDataReceived
			});
